...
router.get('/me', auth, async (req, res) => {
    try{
        // fetching profile based on the user id that comes with the token ( the auth middleware )
...
router.post('/', [auth, [
    ...
    try{
        ...
        // Update
        // new : true, returns the document after updating it
        if(profile){
